    ...
    <View style={[styles.container, { width: screenDimensions.width }]}>
      ...
      <View style={styles.inputBox}>
        <View style={[styles.inputOuter]}>
          <TextInput style={styles.input} keyboardType="text" placeholder="Name" />
        </View>
        <View style={[styles.inputOuter]}>
          <TextInput style={styles.input} keyboardType="email" placeholder="Email" />
        </View>
     ...
     <Text style={styles.terms}>By selecting Agree and continue, I agree to the <Text style={{ color: 'red' }}>Terms of Service</Text>, and <Text style={{ color: 'red' }}>Notification Policy</Text> and acknowledge the <Text style={{ color: 'red' }}>Privacy Policy</Text>.</Text>
